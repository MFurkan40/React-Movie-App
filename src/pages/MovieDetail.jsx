...
const MovieDetail = () => {
  ...
  return (
    <div className="container px-10 mx-auto py-5">
      ...
      <h1 className="text-center text-[#000] dark:text-white text-3xl mb-10">
        {title}
      </h1>
      <div className="container flex justify-center px-10">
        <div className="flex flex-col lg:flex-row max-w-6xl rounded-lg bg-gray-100 shadow-lg ">
          <img
            className=" lg:w-1/3 md:h-96 lg:h-[600px] object-cover object-top rounded-t-lg md:rounded-none md:rounded-l-lg"
            src={poster_path ? IMG_API + poster_path : defaultImage}
            alt="poster"
          />
          <div className="p-6 flex flex-col justify-between  dark:bg-gray-300">
            <div>
            ...
            <ul className="bg-gray-100 rounded-lg border border-gray-400 text-gray-900">
              ...
              <li className="px-6 py-2 border-gray-400 w-full rounded-t-lg">
                <Link
                  to={-1}
                  className=" text-[#ff4b45] hover:text-[#e7928f] transition duration-300 ease-in-out mb-4"
                >
                  Go Back
                </Link>
              </li>
