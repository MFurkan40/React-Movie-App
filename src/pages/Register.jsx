  ...
  return (
    <div className="flex justify-center">
      ...
      <div className="overflow-hidden flex-1 h-screen justify-center items-center mt-1  dark:bg-[#23242a]">
        <div
          className={`mt-[12vh] mx-auto overflow-hidden relative w-[380px] h-[620px] rounded-[8px] dark:bg-[#1c1c1c] before:content-[""] before:absolute before:w-[380px] before:h-[420px] before:top-[-50%] before:left-[-50%] after:content-[""] after:absolute after:w-[380px] after:h-[420px] after:top-[-50%] after:left-[-50%] custom-linear-gradient`}
        >
          <form
          ...
          >
            ...
            <input
              className="border-none outline-none bg-[#ff4b45] custom-input w-[125px] mt-[10px] rounded-[4px] font-[600] cursor-pointer"
              type="submit"
              value="Register"
            />
            <button
